  ...
  <PageLayout title="Conformité DGSSI / CNDP" currentPath="/conformite">
   <div style={{ padding: '32px', maxWidth: '1200px', margin: '0 auto' }}>
    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '16px', marginBottom: '24px' }}>
     <StatCard label="Score global" value={`${score?.score}/100`} color={statusColor} />
     <StatCard label="Contrôles conformes" value={score?.total_controls - score?.non_conforme_count} color={COLORS.green.main} />
     <StatCard label="Non conformes" value={score?.non_conforme_count} color="#ef4444" />
     <StatCard label="Classement national" value="Top 30%" color={COLORS.gold.main} />
    </div>
    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '20px' }}>
     ...
     <div style={{ backgroundColor: COLORS.white, borderRadius: '16px', padding: '24px', border: `1px solid ${COLORS.border}`, borderTop: `3px solid ${COLORS.gold.main}` }}>
      <h2 style={{ color: COLORS.green.main, fontWeight: 700, marginBottom: '16px', fontSize: '1rem' }}>Radar Conformité</h2>
      <ResponsiveContainer width="100%" height={200}>
    ...
    <div style={{ backgroundColor: COLORS.white, borderRadius: '16px', padding: '24px', border: `1px solid ${COLORS.border}`, borderTop: `3px solid ${COLORS.green.main}`, marginBottom: '20px' }}>
     <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px', flexWrap: 'wrap', gap: '10px' }}>
      <h2 style={{ color: COLORS.green.main, fontWeight: 700, fontSize: '1rem', margin: 0 }}> Contrôles DGSSI</h2>
